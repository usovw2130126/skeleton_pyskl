...
def parse_args():
    ...
    parser.add_argument('config',default='configs/posec3d/slowonly_r50_ntu120_xsub/joint.py', help='test config file path')
    parser.add_argument('checkpoint',default='https://download.openmmlab.com/mmaction/pyskl/ckpt/posec3d/slowonly_r50_ntu120_xsub/joint.pth', help='checkpoint file')
    parser.add_argument('label',default='tools/data/label_map/nturgbd_120.txt', help='label file')
    parser.add_argument(
